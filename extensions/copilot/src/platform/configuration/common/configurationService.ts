...
export namespace ConfigKey {
	...
	*/
	...
	export namespace Deprecated {
		...
		export const AzureModels = defineSetting<Record<string, { name: string; url: string; toolCalling: boolean; vision: boolean; maxInputTokens: number; maxOutputTokens: number; requiresAPIKey?: boolean; thinking?: boolean; streaming?: boolean; zeroDataRetentionEnabled?: boolean; extraBody?: Record<string, unknown> }>>('chat.azureModels', ConfigType.Simple, {});
		export const CustomOAIModels = defineSetting<Record<string, { name: string; url: string; toolCalling: boolean; vision: boolean; maxInputTokens: number; maxOutputTokens: number; requiresAPIKey?: boolean; thinking?: boolean; streaming?: boolean; requestHeaders?: Record<string, string>; zeroDataRetentionEnabled?: boolean; extraBody?: Record<string, unknown> }>>('chat.customOAIModels', ConfigType.Simple, {});
